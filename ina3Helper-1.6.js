    ...
    var ima3Helper = function () {
        ...
        var getCustomParamsQueryString = function getCustomParamsQueryString() {
            ...
            if (requestUri || requestUrl) {
                ...
                var urlParts_temp = urlParts[0].split('.');
            ...
            if (aam_uuid !== false && typeof aam_uuid !== 'undefined') {
                queryString += 'aam_uuid=' + aam_uuid + '&';
            }
        ...
        var getAdUtilTarget = function getAdUtilTarget() {
            ...
            if (inIframe) {
                try {
                    ...
                    } else if (typeof parent.articleMetaData !== 'undefined') {
            ...
            } else if (typeof window.articleMetaData !== 'undefined') {
                return Object.values(window.articleMetaData)[0]["Tags"];
            }
            return false;
        };
        ...
        var getIndexAds = function (a, b) {
            if ("string" != typeof a || "object" != typeof b) return a;
            try {
                b = JSON.stringify(b);
                var c = window.location !== window.parent.location ? document.referrer : window.location.href,
                    d = encodeURIComponent(a).replace(/(%7B)([^%]*)(%7D)/g, "{$2}");
                return console.log(d), "//as-sec.casalemedia.com/playlist?ix_id=%5Bindex_epr%5D&ix_v=8.8&ix_u=" + encodeURIComponent(c) + "&ix_vt=" + d + "&ix_s=191888&ix_vasd=0&ix_ca=" + encodeURIComponent('{"protocols": [2,3,5,6],"mimes":["video/mp4","video/webm","application/javascript","video/x-flv","application/x-shockwave-flash"],"apiList":[1, 2],"size":"640x360","timeout": 1000,"brandExclusion": 1,"durations": [15,30]}') + "&ix_so=" + encodeURIComponent(b)
            } catch (b) {
                return a
            }
        };
        ...
        var getSyndicatedTag = function getSyndicatedTag(player) {
            ...
            if (player.mediainfo) {
                ...
                for (var i in tags) {
                    if (tags[i].indexOf && tags[i].indexOf('syndicated=') >= 0) {
        ...
        player.ready(function () {
            ...
            player.ima3.adMacroReplacement = function (url) {
                ...
                if (url === '{adServerUrl}') {
                    ...
                    console.log('FINAL URL:' + adServerUrl);
                    return adServerUrl;
